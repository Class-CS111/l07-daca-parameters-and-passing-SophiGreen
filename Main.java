...
public class Main
   ...
   
    {
       ...
       public static final String ASCII_ART_0 = "    .----.    .----.  ",
                ...
                TITLE_USA = "UNITED STATES OF AMERICA",
        ...
        birthCountry = UtilityBelt.readString("Enter birthCountry:", 0, 50);
        ...
        birthMonth = UtilityBelt.readString("Enter birth day(as 3 letter acronym in ALL CAPS):", 3, 3);
